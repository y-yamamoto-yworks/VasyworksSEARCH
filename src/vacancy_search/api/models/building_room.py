...
from .room_interior_picture import RoomInteriorPicture
from .room_layout_picture import RoomLayoutPicture
...
class BuildingRoom(models.Model):
    ...
    """
    @classmethod
    def get_rooms(cls, building_id: int, conditions: MapSearchConditions, is_residential):
        """建物部屋の取得"""
        params = {}
    ...
    @classmethod
    def __get_sql_tables(cls, building_id: int, conditions: MapSearchConditions, params, is_residential):
        """SQLのテーブル一覧"""
        ans = 'room'
    ...
    def interior_picture(self):
        return RoomInteriorPicture.get_picture(self.id)

    @property
    def layout_picture(self):
        return RoomLayoutPicture.get_picture(self.id)

    @property
    def equipments(self):
        return RoomEquipment.get_equipments(self.id)
