...
2. About VasyworksSEARCH (Vacancy Information Search Project)
VasyworksSEARCH is a project that allows staff members of the company's brokerage department to search for vacancy information on Vasyworks using maps, etc. It uses the database built by VasyworksDB and the vacancy information data registered by VasyworksMGR. The company's own users registered in VasyworksMGR can use VasyworksSEARCH to search for property information and view details.

3.About the license of VasyworksSEARCH
The source code of VasyworksSEARCH is copyrighted by Yasuhiro Yamamoto and can be used under the license conditions of AGLPv3.
